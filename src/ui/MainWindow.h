...
public:
    ...
    // Called by AppCore::releaseWindow() to durably save every view setting
    ...
    void showDemoLibraryTrack(const QString &query);
    void showDemoQueue(const QString &query);
...
private:
    ...
    MainPanelTarget libraryAlbumsPanelTarget();
    MainPanelTarget libraryTracksPanelTarget();
    MainPanelTarget musicExplorerAlbumsPanelTarget(MusicExplorerView *musicExplorer);
    MainPanelTarget musicExplorerTracksPanelTarget(MusicExplorerView *musicExplorer);
    void installLibraryMainPanelTargets();
    void installMusicExplorerMainPanelTargets(MusicExplorerView *musicExplorer);
