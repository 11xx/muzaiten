...
QVector<KeyBindingProfile> defaultKeyBindingProfiles()
{
...

    {
        ...
        p.hintText = QStringLiteral("j\u2193 k\u2191 h\u2190 l\u2192  ggG  Spc\u25b6 a\u266b q+ p\u25b6\u25b6 if b\u2691 ~ Esc");
        p.bindings = {
            {Qt::Key_J, MoveDown},
            {Qt::Key_K, MoveUp},
            {Qt::Key_H, NavigateUp},
...

    {
        ...
        p.hintText = QStringLiteral("n\u2193 p\u2191  Spc\u25b6  s+ a\u266b !\u25b6\u25b6  if b\u2691 ~ q");
        p.bindings = {
            {Qt::Key_N, MoveDown},
            {Qt::Key_P, MoveUp},
...

    {
        ...
        p.hintText = QStringLiteral("j\u2193 k\u2191 h\u2190 l\u2192  n\u2193 p\u2191  Spc\u25b6  s+ a\u266b !\u25b6\u25b6  if b\u2691 ~ q");
        p.bindings = {
            {Qt::Key_J, MoveDown},
            {Qt::Key_K, MoveUp},
            {Qt::Key_H, NavigateUp},
