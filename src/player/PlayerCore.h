...
signals:
    // Emitted before a navigation that should not count as rejecting the
    // outgoing track: Previous, or a direct jump to a chosen queue row.
    void aboutToNavigateWithoutRejecting();
